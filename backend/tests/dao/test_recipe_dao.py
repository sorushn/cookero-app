...
def test_get_by_user_id(db_user):
    ...
    assert retrieved_recipe[0]['name'] == recipe['name']
    assert retrieved_recipe[0]['instructions'] == recipe['instructions']
    assert retrieved_recipe[0]['id'] == recipe['id']